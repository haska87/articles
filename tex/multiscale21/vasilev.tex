...
Let us consider the symmetric form of the SP$_3$ equation for the neutron flux \citep{ryu2013fem}.
...
\begin{equation}\label{7}
	A_f \phi = b_f,
\end{equation}
where the operator $A_f$ corresponds to the bilinear form of equation, and the vector $b_f$ corresponds to the linear form of equation (\ref{6}).
...
% POU
%\textbf{Partition of unity functions. } 
