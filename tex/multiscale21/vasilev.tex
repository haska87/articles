...
\begin{figure}[ht]
	\centering
		a)\includegraphics[width=0.3\linewidth]{small/u1-1_ms.png}
		b)\includegraphics[width=0.3\linewidth]{small/u1-2_ms.png}
		c)\includegraphics[width=0.3\linewidth]{small/u1-4_ms.png}
		d)\includegraphics[width=0.3\linewidth]{small/u1-8_ms.png}
		e)\includegraphics[width=0.3\linewidth]{small/u1-16_ms.png}
		f)\includegraphics[width=0.3\linewidth]{small/u1-32_ms.png}
...
\begin{figure}[ht]
	\centering
		a)\includegraphics[width=0.3\linewidth]{twigl/u1-1_ms.png}
		b)\includegraphics[width=0.3\linewidth]{twigl/u1-2_ms.png}
		c)\includegraphics[width=0.3\linewidth]{twigl/u1-4_ms.png}
		d)\includegraphics[width=0.3\linewidth]{twigl/u1-8_ms.png}
		e)\includegraphics[width=0.3\linewidth]{twigl/u1-16_ms.png}
		f)\includegraphics[width=0.3\linewidth]{twigl/u1-32_ms.png}
		g)\includegraphics[width=0.3\linewidth]{twigl/u1_f.png}
	\caption{Fine-grid (g) and multiscale solutions at final time for pseudo 0th moment of angular flux: a) 1 basis b) 2 bases c) 4 bases d) 8 bases e) 16 bases f) 32 bases.}
