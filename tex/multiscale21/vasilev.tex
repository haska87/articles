...
For delayed neutron source equation we use numerical-analytical method for the construction of approximations
in time. 
...
%For $\bm v = \{v_1, v_2, ..., v_d\}$ define $V^d = [H^1(\Omega)]^d$. 
%For test functions use notations $\bm \xi  = \{\xi_1, \xi_2, ..., \xi_G\}$, $\bm \zeta  = \{\zeta_1, \zeta_2, ..., \zeta_M\}$.
...
\begin{split}
\int_{\Omega} \left( \frac{\phi^{n+1}_{0,g} - \phi^{n}_{0,g}}{v_g \tau} - 
			  \frac{2(\phi^{n+1}_{2,g} - \phi^{n}_{2,g})}{v_g \tau}\right) q_g d\bm{x} - 
\int_{\Omega} D_{0,g}\nabla \phi^{n+1}_{0,g} \nabla q_g d\bm{x} + 
\int_{\partial\Omega} J_{0,g} q_g d\bm{s} + \\
\int_{\Omega} \left( \Sigma_{r,g} \phi^{n+1}_{0,g} - 2\Sigma_{r,g} \phi^{n+1}_{2,g} \right) q_g d\bm{x} = 
\int_{\Omega} \left( (1-\beta)\chi_{n,g} S_{n} + S_{s,g} + \chi_{d,g} S_d \right) q_g d\bm{x}, \\
\int_{\Omega} \left( -\frac{2(\phi^{n+1}_{0,g} - \phi^{n}_{0,g})}{v_g \tau} + 
			  \frac{9(\phi^{n+1}_{2,g} - \phi^{n}_{2,g})}{v_g \tau} \right) q_g d\bm{x} - 
\int_{\Omega} D_{2,g}\nabla \phi^{n+1}_{2,g} \nabla  q_g d\bm{x} + 
\int_{\partial\Omega} J_{2,g} q_g d\bm{s} + \\
\int_{\Omega} \left( (5\Sigma_{t,g} + 4\Sigma_{r,g}) \phi^{n+1}_{2,g} - 2\Sigma_{r,g} \phi^{n+1}_{0,g} \right) q_g d\bm{x} =  
\int_{\Omega} \left( -2(1-\beta)\chi_{n,g} S_{n} - 2S_{s,g} - 2\chi_{d,g} S_d \right) q_g d\bm{x},
\end{split}
\end{equation}
