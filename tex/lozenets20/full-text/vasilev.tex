...
\author{A.O. Vasilev\inst{1} \and D.A. Spiridonov\inst{1} \and A.V. Avvakumov\inst{2} }
...
\keywords{parabolic equation, neutron diffusion, multiscale simulation, generalized multiscale finite element method (GMsFEM)}
